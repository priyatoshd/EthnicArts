...
import com.example.ethnicarts.Model.Cart;
import com.example.ethnicarts.Prevalent.Prevalent;
import com.example.ethnicarts.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    private TextView txtHomeButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtHomeButton = (TextView)findViewById(R.id.cart_home_btn);



        txtHomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
